...
<div x-data="{{ $bannerData }}"
    ...
    message = event.detail.message; show = true;">
        ...
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span
                    ...
                    :class="{
                        'bg-sky-600': style == 'success',
                        'bg-fuchsia-600': style == 'danger',
                        'bg-yellow-600': style == 'warning'
                    }">
                    <svg x-show="style == 'success'"
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    type="button"
                    class="-me-1 flex p-2 rounded-md focus:outline-none sm:-me-2
                    transition"
                    :class="{
                        'hover:bg-sky-600 focus:bg-sky-600': style == 'success',
                        'hover:bg-fuchsia-600 focus:bg-fuchsia-600': style == 'danger',
