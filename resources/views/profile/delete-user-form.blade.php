<x-action-section>
    ...
    <x-slot:description>Permanently delete your account.</x-slot:description>
    ...
    <x-slot:content>
        <x-profile.description
            ...
            retain.</x-profile.description>

        <div class="mt-5">
            <x-danger-button wire:click="confirmUserDeletion"
                wire:loading.attr="disabled">Delete Account</x-danger-button>
        </div>
