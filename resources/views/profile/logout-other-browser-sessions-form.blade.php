<x-action-section>
    <x-slot:title>Browser Sessions</x-slot:title>

    <x-slot:description
        >Manage and log out your active sessions on other browsers and
        devices.</x-slot:description>
    ...
    <x-slot:content>
        <x-profile.text
            ...
            account has been compromised, you should also update your
            password.</x-profile.text>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        ...
                                        font-semibold">This device</span>
                                    @else
        ...
        <div class="flex items-center mt-5">
            <x-button wire:click="confirmLogout"
                ...
                >Log Out Other Browser Sessions</x-button>

            <x-action-message class="ms-3" on="loggedOut"
                >Done.</x-action-message>
        </div>

        <!-- Log Out Other Devices Confirmation Modal -->
        <x-dialog-modal wire:model.live="confirmingLogout">
            <x-slot:title>Log Out Other Browser Sessions</x-slot:title>
